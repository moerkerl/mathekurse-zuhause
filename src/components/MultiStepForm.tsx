...
export default function MultiStepForm() {
  ...
  const handleNext = (e?: React.FormEvent) => {
    ...
    if (step === 2 && !form.thema) return setError('Bitte geben Sie das gewünschte Mathe-Thema an.')
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-8">
      ...
      {step === 2 && (
        <form onSubmit={handleNext}>
          <h2 className="text-2xl font-bold mb-6 text-gray-900">
            In welchem Mathe-Bereich benötigen Sie Unterstützung?
          </h2>
          ...
          <input
            ...
            placeholder="Mathe-Thema eingeben..."
          />

          <div className="mb-4">
            <p className="text-sm text-gray-600 mb-3">Oder wählen Sie aus beliebten Themen:</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {themenBeispiele.map(thema => (
                <button
                  key={thema}
                  type="button"
      ...
      {step === 4 && (
        <form onSubmit={handleSubmit}>
          ...
          <p className="text-gray-600 mb-6">
            Damit wir Ihnen die passende Auswahl an Mathelehrern in der Schweiz zusenden können.
          </p>
