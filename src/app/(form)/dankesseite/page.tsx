        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Wir analysieren Ihre Anforderungen und suchen passende Mathelehrer</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">📞</span>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Vorstellung von 2-3 qualifizierten Mathelehrern</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Sie wählen Ihren Wunsch-Mathelehrer und starten</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Geprüfte Mathelehrer</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Mathekurse in der ganzen Schweiz</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="bg-green-100 rounded-full p-2 mr-3 mt-1">
          ...
          <div className="bg-gradient-to-br from-[#047857] to-[#065f46] rounded-2xl shadow-lg p-8 text-white">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="text-blue-100 text-sm">Mathelehrer schweizweit</div>
              </div>
              <div>
                <div className="text-3xl font-bold mb-2">1&apos;000+</div>
                <div className="text-blue-100 text-sm">Erfolgreiche Mathekurse</div>
              </div>
              <div>
            ...
            <div className="mt-6 pt-6 border-t border-blue-400">
              <p className="text-sm opacity-90">
                &ldquo;Dank Mathekurse-Zuhause verstehe ich endlich Analysis. Mein Lehrer war fantastisch!&rdquo;
              </p>
